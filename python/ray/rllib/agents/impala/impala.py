...
from ray.rllib.agents.impala.impala_policy_graph import ImpalaPolicyGraph
...
class ImpalaAgent(Agent):
    """Impala implementation in TensorFlow."""

    _agent_name = "Impala"
    _default_config = DEFAULT_CONFIG
    _policy_graph = ImpalaPolicyGraph
    ...
    def _init(self):
        self.config["sample_batch_size"] = self.config["unroll_length"]
